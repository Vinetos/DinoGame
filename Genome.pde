class Genome {
  ArrayList<connectionGene> genes = new  ArrayList<connectionGene>();// Une liste de connexion entre les noeuds qui représente le Neural Network
  ...
  ArrayList<Node> network = new ArrayList<Node>();// Une liste de noeuds dans l'ordre dans lequel ils doivent être pris en compte dans le NN
  //---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  Genome(int in, int out) {
    // Définit le numéro d'entrée et le numéro de sortie
    inputs = in;
    outputs = out;

    // Crée des noeuds d'entrée
    ...
    nodes.add(new Node(nextNode));// Noeud de biais
    biasNode = nextNode; 
    nextNode++;
